...
import { ArrowLeft, Bell, Menu, PanelLeftClose, PanelLeftOpen, Search, ShieldCheck } from 'lucide-react';
...
export default function Navbar({ onMenuClick, desktopCollapsed = false, onToggleSidebar }) {
  ...
  const puedeVolver = !['/dashboard', '/auditoria', '/admin/matriz'].includes(location.pathname);
      ...
      <div className="flex min-w-0 items-center gap-3">
        ...
        {puedeVolver && (
          <button
            ...
            className="inline-flex h-10 items-center gap-2 rounded-xl border border-slate-200 bg-white px-3 text-sm font-black text-slate-700 shadow-sm transition hover:bg-slate-50"
